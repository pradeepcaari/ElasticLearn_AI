...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  [data-theme="dark"] {
    ...
    --login-bg-glow:  rgba(26, 58, 107, 0.7);
    --ambient-glow:   rgba(26, 58, 107, 0.35);
    --grid-border:    rgba(201, 168, 76, 0.06);
    --quote-bg:       rgba(11, 22, 40, 0.5);
    --quote-border:   var(--border);
    --quote-text:     var(--cream);
  ...
  [data-theme="light"] {
    ...
    --gold-dim:       rgba(158, 124, 43, 0.08);
    --login-bg-glow:  rgba(201, 168, 76, 0.16);
    --ambient-glow:   rgba(201, 168, 76, 0.08);
    --grid-border:    rgba(158, 124, 43, 0.06);
    --quote-bg:       rgba(255, 255, 255, 0.65);
    --quote-border:   rgba(158, 124, 43, 0.15);
    --quote-text:     var(--cream-lt);
