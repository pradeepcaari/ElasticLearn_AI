  ...
  foundation: {
    ...
    desc:   (gaps) =>
      gaps.length > 0
        ...
        : `We'll start by strengthening your core fundamentals step-by-step with clear analogies and prerequisite bridges before advancing to harder concepts.`,
    features: [
...
export default function ResultPage({ level, gaps }) {
