...
export function CrosshairCursor({ color = "var(--gold)", size = 20 }) {
  return (
...
export function DotCursor({ color = "var(--gold)", size = 8 }) {
  return (
    <div
      style={{
        width: size,
...
export function RingCursor({ color = "var(--gold)", size = 24 }) {
  return (
    <div
      style={{
        width: size,
